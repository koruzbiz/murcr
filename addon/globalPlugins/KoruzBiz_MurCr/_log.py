...
def _default_log_dir(alt_klasor="Koruz_Biz\\MurCr"):
...
def _mesaj_temizle(msg, logger_adi):
    """
    Kullanıcı yanlışlıkla 'INFO MurCr: ...' gibi prefix gönderirse tekrar oluşmasın.
...
class BasitLogger:
    ...
    def _fmt(self, seviye, msg):
        # İstenen format:
        # DEBUG MurCr: başla - 2025-12-24 19:56:57
